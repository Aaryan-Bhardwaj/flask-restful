...
video_put_args.add_argument("likes", type=int, help="Likes of video missing", required=True)
...
video_update_args.add_argument("likes", type=int, help="Likes of video missing")
...
# 		abort(402, message="Video with this id already exists...")
